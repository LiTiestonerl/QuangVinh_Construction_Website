<section id="constructions" class="constructions section py-5 bg-light">
  <div class="container section-title" data-aos="fade-up">
    <h2>Công trình tiêu biểu</h2>
    <p>Những dự án đã hoàn thành của Xây Dựng Quang Vinh – chất lượng khẳng định thương hiệu.</p>
  </div>
      ...
      <div class="col-lg-6" data-aos="fade-up">
        <div class="card-item d-flex flex-wrap bg-white rounded-4 shadow-sm overflow-hidden">
          ...
          <div class="col-xl-7 p-4">
            ...
            <p class="text-muted">Diện tích 1000m², thi công trong 45 ngày. Kết cấu thép vững chắc, mái chống nóng,
              bàn giao đúng tiến độ.</p>
          </div>
        </div>
      </div>
      ...
      <div class="col-lg-6" data-aos="fade-up" data-aos-delay="100">
        <div class="card-item d-flex flex-wrap bg-white rounded-4 shadow-sm overflow-hidden">
          ...
          <div class="col-xl-7 p-4">
            ...
            <p class="text-muted">Nhà ống 2 tầng mái Thái hiện đại, thiết kế tối ưu gió tự nhiên. Hoàn thiện sau 4
              tháng.</p>
          </div>
        </div>
      </div>
      ...
      <div class="col-lg-6" data-aos="fade-up" data-aos-delay="200">
        <div class="card-item d-flex flex-wrap bg-white rounded-4 shadow-sm overflow-hidden">
          ...
          <div class="col-xl-7 p-4">
            ...
            <p class="text-muted">Gia cố nền, thay mới hệ thống mái và cửa sổ, tăng hiệu quả sản xuất.</p>
          </div>
        </div>
      </div>
      ...
      <div class="col-lg-6" data-aos="fade-up" data-aos-delay="300">
        <div class="card-item d-flex flex-wrap bg-white rounded-4 shadow-sm overflow-hidden">
          ...
          <div class="col-xl-7 p-4">
            ...
            <p class="text-muted">Phá dỡ nhà cũ 3 tầng trong khu dân cư đông đúc, đảm bảo an toàn tuyệt đối.</p>
          </div>
        </div>
      </div>
    </div>
